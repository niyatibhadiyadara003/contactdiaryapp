          ...
          children: [
            ...
            Container(
              alignment:const Alignment(-0.8,0),
                ...
                child: Text("+91 ${args.phone}",style:const TextStyle( fontSize:18))),
            const SizedBox(height:20),
            const Divider(
              color: Colors.black,
              indent: 20,
              ...
              children: [
                FloatingActionButton(
                  onPressed: ()async{
                    ...
                    await canLaunch("tel:+91 "+args.phone);
                ...
                FloatingActionButton(
                  onPressed: ()async{
                    ...
                    await canLaunch("sms:+91 "+args.phone);
                ...
                FloatingActionButton(
                  onPressed: ()async{
                    ...
                    await canLaunch("mailto:+91 "+args.phone);

                    await launch("mailto:+91 "+args.phone);
